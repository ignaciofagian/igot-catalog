 ...
 */
 router.post(`/abbreviature/delete`, async function postAbbreviatureDelete(req: Request, res: Response) {
 ...
 * Post add attribute
 */
 router.post(`/attribute/add`, async function postAbbreviatureAdd(req: Request, res: Response) {
